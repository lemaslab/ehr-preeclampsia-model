...
# data_dir=paste0("/Volumes/SHARE/FACULTY/DJLEMAS/EHR_Data/raw/dataset_10_2021/")
...
# filter() to encounter for each ICD9/10 code per participant ID
ehr_codes=df %>%
group_by(part_id, perinatal_dx_code) %>%
