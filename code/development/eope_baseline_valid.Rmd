...
df$Coagulopathy<-as.numeric(df$Coagulopathy)
df$PulmonaryCirculationDisorders<-as.numeric(df$PulmonaryCirculationDisorders)
df$RaceName.African.American<-as.numeric(df$RaceName.African.American)
...
#load("coxph_eope_model0601.RData") 
