...
df$class<-ifelse(df$V1>median(df$V1), "High Risk Group", "Low Risk Group")
...
data$Feature<-factor(data$Feature, levels=c("Mean_Fetuses", "Mean_Depression", "Mean_NSAIDs", "Mean_Parity", "Mean_Antacids", "Mean_Hypertension", "Mean_Anxiety", "Mean_Benzodiazepine", "Mean_TypeIDiabetes", "Mean_TypeIIDiabetes"))
