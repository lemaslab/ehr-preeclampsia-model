...
for (i in 0:9)
{
  #model = "_low_cor"
  j = i+1
  x_train_1 <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/x_train%s%d.csv",model, i), header = TRUE)
  x_test_1 <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/x_test%s%d.csv",model, i), header = TRUE)
  ytime_train_1 <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/ytime_train%s%d.csv", model,i), header = TRUE)
  ytime_test_1 <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/ytime_test%s%d.csv", model,i), header = TRUE)
  ystatus_train_1 <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/ystatus_train%s%d.csv", model,i), header = TRUE)
  ystatus_test_1 <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/ystatus_test%s%d.csv", model,i), header = TRUE)
...
for (i in 0:9)
{
  ...
  theta_coxnnet_adam_dropout <- read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/SRTR_theta_hcc_new%d.csv",i), header = FALSE)
  ...
  theta_train = read.csv(sprintf("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/SRTR_theta_train%d.csv",i), header = FALSE)
