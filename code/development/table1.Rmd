...
baby_mom_at_birth_with_payer=read_csv("C:/Users/haile/OneDrive/ehr-preeclampsia-model/data/raw/baby_mom_at_birth_with_payer.csv")
...
data_table1=timetodiagnosis_v1
...
```{r, message=FALSE}
#Mean materna age
data_final_v7_Full$MaternalAge<-data_final_v7_Full$MaternalAge*365

mean_ma<-mean(data_final_v7_Full$MaternalAge, trim=0.3)
sd_ma<-sd(data_final_v7_Full$MaternalAge)

#gravidity
mean_gravidity<-mean(data_table1$gravidity, trim=0.3)
sd_gravidity<-sd(data_table1$gravidity)

#parity
mean_parity<-mean(data_table1$parity, trim=0.3)
sd_parity<-sd(data_table1$parity)
...
#time to deliver
data_table1$TimetoDiagnosis<-as.numeric(data_table1$TimetoDiagnosis)
mean_ttd<-mean(data_table1$TimetoDiagnosis, trim=0.3)
sd_ttd<-sd(data_table1$TimetoDiagnosis)
