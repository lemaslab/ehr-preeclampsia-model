...
mom_alcohol_release<-read_csv("~/ehr-preeclampsia-model/data/raw/mom_alcohol_release.csv")

mom_comorbidities_icd10<-read_csv("~/ehr-preeclampsia-model/data/raw/mom_comorbidities_list_ICD10_release.csv")

mom_comorbidities_icd9<-read_csv("~/ehr-preeclampsia-model/data/raw/mom_comorbidities_list_ICD9_release.csv")

mom_bateman<-read_csv("~/ehr-preeclampsia-model/data/raw/mom_comorbidities_list_batman_release.csv")
