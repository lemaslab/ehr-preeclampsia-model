...
demo_ready_v1 =demo_ready %>%
  add_column(AlcoholAbuse= 0, anxiety=0,
             ...
             SolidTumorWithoutMetastasis=0, ValvularDisease=0, WeightLoss=0)
   
   # file name
file_name="demo_ready_v1.csv"
...
data_ready_v0 =ehr_ready %>%
  add_column(AlcoholAbuse= 0, anxiety=0,
   ...
   # file name
file_name="data_ready_v0.csv"
data_export_directory=paste0("~/ehr-preeclampsia-model/data/demo/") 
data_export_path=paste0(data_export_directory,file_name)
write_csv(data_ready_v0, file=data_export_path)

# shiny ap output (base predictors): C-index of Cox-nnet model  : 0.491 
#                                   C-index of the Cox-ph model: 0.544
