...
ehr_ready =ehr_ready %>%
  add_column(IllegalDrugUserStatusNo= 0, SexuallyActiveStatusSourceNever= 0, SexuallyActiveStatusSourceNo = 0, SexuallyActiveStatusSourceNot.Currently= 0, SexuallyActiveStatusSourceYes =0)
