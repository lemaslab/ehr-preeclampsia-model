...
df_filtered$part_id<-paste(df_filtered$part_id, df_filtered$year, sep = "-")
...
delivery_final_v9$mom_id<-paste(delivery_final_v9$mom_id, delivery_final_v9$year, sep = "-")
...
delivery_final_v9=delivery_final_v9%>%
  filter(between(delivery_final_v9$time_to_deliver, -150, 150))
